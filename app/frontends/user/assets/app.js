...
const elements = {
  ...
  personaProfessionalButton: document.querySelector(
    "#personaProfessionalButton",
  ),

  personaCoachButton: document.querySelector(
    "#personaCoachButton",
  ),
};
...
const recommendationPool = [
  ...
  {
    title: "혈압 기준 알아보기",
    question: "수축기 혈압과 이완기 혈압은 무엇이 다른가요?",
  },
  {
    title: "검진 결과 이해하기",
    question: "건강검진에서 정상B 판정은 무슨 뜻인가요?",
  },
  {
    title: "간 기능 검사 알아보기",
    question: "AST와 ALT 검사는 무엇을 확인하는 검사인가요?",
  },
  {
    title: "콜레스테롤 이해하기",
    question: "HDL과 LDL 콜레스테롤은 어떻게 다른가요?",
  },
  {
    title: "중성지방 알아보기",
    question: "중성지방 수치가 높으면 일반적으로 무엇을 확인하나요?",
  },
  {
    title: "체질량지수 알아보기",
    question: "BMI는 어떻게 계산하고 결과를 어떻게 해석하나요?",
  },
  {
    title: "빈혈 정보 알아보기",
    question: "빈혈의 대표적인 원인과 증상을 알려주세요.",
  },
  {
    title: "감기 정보 알아보기",
    question: "감기의 대표적인 원인과 증상을 알려주세요.",
  },
  {
    title: "고혈압 알아보기",
    question: "고혈압의 대표적인 원인과 증상은 무엇인가요?",
  },
  {
    title: "당뇨병 알아보기",
    question: "당뇨병의 대표적인 증상과 위험 요인을 알려주세요.",
  },
  {
    title: "건강 습관 알아보기",
    question: "고혈압 예방에 도움이 되는 생활 습관을 알려주세요.",
  },
  {
    title: "혈색소 수치 알아보기",
    question: "혈색소 검사는 무엇을 확인하고 수치는 어떻게 해석하나요?",
  },
  {
    title: "신장 기능 알아보기",
    question: "신장 기능 검사에서는 일반적으로 어떤 항목을 확인하나요?",
  },
  {
    title: "간 건강 알아보기",
    question: "간 건강을 관리하는 데 도움이 되는 생활 습관을 알려주세요.",
  },
  {
    title: "검진 전 준비하기",
    question: "건강검진 전에 금식이 필요한 이유를 알려주세요.",
  },
];
...
function setPersona(persona) {
  ...
  elements.personaProfessionalButton
    ?.classList.toggle(
      "active",
      isProfessional,
    );

  elements.personaCoachButton
    ?.classList.toggle(
      "active",
      !isProfessional,
    );
...
function setAuthMode(mode) {
  ...
  elements.signupModeButton.classList.toggle(
    "active",
    isSignup,
  );
  ...
  elements.loginTitle.textContent = (
    isSignup
      ? "HEAPY와 함께 시작해요"
      : "다시 만나서 반가워요"
  );
...
function hideInitialLoadingScreen() {
  ...
  const delay = Math.max(
    0,
    INITIAL_LOADING_MINIMUM_MS - elapsed,
  );

  window.setTimeout(
    () => {
      elements.initialLoadingScreen
...
function confirmConversationDeletion(
  ...
  elements.deleteConversationTitle
    .textContent = (
      `“${title || "새 대화"}”`
    );

  elements.deleteConversationDialog
    .returnValue = "cancel";
...
async function deleteConversation(
  ...
  const confirmed = (
    await confirmConversationDeletion(
      title,
    )
  );
...
function updateConversationSessionPreview(
  data,
) {
...
function updateLoadingProgress(payload) {
  const status = document.querySelector(
    '[data-loading="true"] .loading-status',
  );
...
function appendAssistantMessage(data) {
  ...
  let bubble = message.querySelector(
    ".bubble",
  );
  ...
  let content = message.querySelector(
    ".message-content",
  );
...
function appendStreamToken(text) {
  ...
  message.dataset.rawAnswer = (
    `${message.dataset.rawAnswer || ""}${text}`
  );
...
function updateConversationMemory(data) {
  ...
  updateConversationSessionPreview(
    data,
  );
...
elements.signupModeButton.addEventListener(
  "click",
  () => setAuthMode(
    "signup",
  ),
