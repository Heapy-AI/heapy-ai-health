...
from app.schemas.checkup_report import (
    CheckupReportRequest,
    CheckupReportResponse,
)

from app.services.checkup_report import (
    CheckupReportService,
)
...
from app.routers.personal_data import (
...
@router.post(
    "/report",
    response_model=CheckupReportResponse,
)
